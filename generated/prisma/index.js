...
const config = {
  generator: {
    ...
    output: {
      value: "/home/heatforge/Coding/chatterbox/chatterbox/generated/prisma",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
    ...
    previewFeatures: [],
    sourceFilePath:
      "/home/heatforge/Coding/chatterbox/chatterbox/prisma/schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
...
path.join(
  process.cwd(),
  "generated/prisma/libquery_engine-debian-openssl-1.0.x.so.node",
);
// file annotations for bundling tools to include these files
